#!/usr/bin/env python3
"""
Validate the Next.js Developer skill structure and files.
"""
...
def main():
    ...
    print("=" * 50)
    print("NEXT.JS DEVELOPER SKILL VALIDATOR")
    print("=" * 50)
    ...
    if all(results.values()):
        ...
        print("\nExample:")
        print("  python ~/.claude/skills/nextjs-developer/scripts/init_project.py test-app")
        print("  cd test-app")
        print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py button card")
        return 0
    else:
