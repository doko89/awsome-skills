...
def list_components():
    ...
    print("\n💡 Usage:")
    print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py button")
    print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py button card dialog")
    print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py --all-forms")
    print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py --registry https://www.shadcn.io/registry/ai.json")
...
def main():
    ...
    if not args.components:
        ...
        print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py button")
        print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py button card dialog")
        print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py --list")
        print("  python ~/.claude/skills/nextjs-developer/scripts/add_component.py --preset essential")
        sys.exit(1)
